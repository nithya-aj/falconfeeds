...
const TopBar = () => {
  return (
    <div className="flex items-center justify-between uppercase py-8 px-20">
      ...
      <div className="flex items-center gap-7">
        <div className="flex items-center gap-4 text-[#FCD34D] font-semibold text-xs bg-[#1F1D17] py-1.5 px-3 rounded-sm cursor-pointer">
          <MdOutlineDiamond size={14} />
          <p>UPGRADE TO PREMIUM</p>
        </div>
        <div className="flex items-center gap-4 text-[#E5E5E5] font-medium text-sm cursor-pointer">
